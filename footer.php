    ...
    <div class="footer__inner inner">
      <div class="footer__top">
        ...
        <div class="footer__sns">
          <a href="https://ja-jp.facebook.com/" class="footer__sns-image" target="_blank"><img src="<?php echo esc_url(get_theme_file_uri('')); ?>/assets/images/common/FacebookLogo-sp.png" alt="フェイスブック" class="footer__facebook"></a>
          <a href="https://www.instagram.com/" class="footer__sns-image" target="_blank"><img src="<?php echo esc_url(get_theme_file_uri('')); ?>/assets/images/common/Insta-sp.png" alt="インスタグラム" class="footer__instagram"></a>
        </div>
      </div>
