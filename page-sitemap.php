...
<div class="sitemap__article lower-article">
    <div class="sitemap__inner inner">
        <div class="sitemap__breadcrumb breadcrumb">
        ...
        <div class="sitemap__wrapper sitelist">
            <nav class="sitelist__nav sitelist__nav--sitemap">
                <ul class="sitelist__nav-left">
                  ...
                  <li class="sitelist__nav-unit"><a href="" class="sitelist__nav-link">ライセンス取得</a></li>
                  <li class="sitelist__nav-unit"><a href="" class="sitelist__nav-link">貸切体験ダイビング</a></li>
                  <li class="sitelist__nav-unit"><a href="" class="sitelist__nav-link">ナイトダイビング</a></li>
                ...
                <ul class="sitelist__nav-right">
                  ...
                  <li class="sitelist__nav-unit"><a href="" class="sitelist__nav-link">ライセンス講習</a></li>
                  <li class="sitelist__nav-unit"><a href="" class="sitelist__nav-link">体験ダイビング</a></li>
                  <li class="sitelist__nav-unit"><a href="" class="sitelist__nav-link">ファンダイビング</a></li>
