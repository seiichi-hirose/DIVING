            ...
            <div class="header-drawer__body">
              <nav class="header-drawer__nav">
                <ul class="header-drawer__nav-left">
                  ...
                  <li class="header-drawer__nav-unit"><a href="<?php echo esc_url(home_url('')); ?>/campaign-category/campaign-license">ライセンス講習</a></li>
                  <li class="header-drawer__nav-unit"><a href="<?php echo esc_url(home_url('')); ?>/campaign-category/campaign-experience">体験ダイビング</a></li>
                  <li class="header-drawer__nav-unit"><a href="<?php echo esc_url(home_url('')); ?>/campaign-category/campaign-fan">ファンダイビング</a></li>
